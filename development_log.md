...
As a result, I started scoping an app where customer can order products from suppliers. Suppliers and customers would have different options when using the app.
